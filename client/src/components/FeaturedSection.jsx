  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-44 overflow-visible'>
      <div className='relative flex items-center justify-between pt-20 pb-10'>
        ...
        <p className='text-gray-300 font-mediium text-lg' >Now Showing</p>
        <button onClick={()=>navigate('/movies')} className='group flex items-center gap-2 text-sm tsxt-gray-300 
